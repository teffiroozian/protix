export const CATEGORY_PRIORITY_GROUPS = [
...
export const INGREDIENT_CATEGORY_PRIORITY_GROUPS = [
  {
    label: "Included Ingredient",
    aliases: ["included ingredient", "included ingredients"],
  },
  ...
  { label: "Breakfast Buns", aliases: ["breakfast bun", "breakfast buns"] },
  {
    ...
    aliases: ["breakfast protein", "breakfast proteins"],
  },
