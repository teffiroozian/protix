...
export default function StickyMacroTotalsBar({
  ...
  const wrapperClassName = inline
    ? "w-full"
    : `fixed left-0 right-0 bottom-1 z-[120] transition-all duration-300 ease-out ${
        visible
  ...
  return (
    <div className={wrapperClassName}>
      <div className={`mx-auto w-full px-2 ${alignToMenuContent ? "max-w-[1200px]" : "max-w-6xl"}`}>
        <div className={alignToMenuContent ? "lg:grid lg:grid-cols-[240px_minmax(0,1fr)] lg:gap-6" : ""}>
          <div className={alignToMenuContent ? "lg:col-start-2" : ""}>
            <div className={`${panelClassName} ${alignToMenuContent ? "max-w-[900px]" : ""}`}>
